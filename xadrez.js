                ...
                if (elementoDestino.tagName == "DIV" || elementoDestino.tagName == "div") {
                    if (elementoDestino.innerHTML == "") {
                        ...
                        function moverCavalo(pecaAnalisada, elementoDestino){
                            ...
                            let numVetorLinhaPeca = linhas.indexOf(colunaQuadrantePecaAtual);
                            consol.log("numeroVetorColunaPeca: ", numVetorColunaPeca);
                            ...
                            let numeroVetorLinhaQuadrante = linhas.indexOf(elementoDestino.dataset.line);
